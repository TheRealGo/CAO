...
- When the runtime provides an interactive choice prompt, prefer a compact choice UI such as `Yes`, `No`, and `Other` over a plain-text Yes/No line for user decisions.
